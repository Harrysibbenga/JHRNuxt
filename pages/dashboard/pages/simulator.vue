    ...
    <mdb-container>
      <mdb-row>
        <mdb-col class="text-center pt-2">
          <img v-if="sim.url" :src="sim.url" :alt="sim.alt" class="img-fluid" />
  ...
  methods: {
    ...
    saveFile() {
      if (this.type === "new") {
        ...
        setTimeout(() => {
          ...
          this.sim.imgId = this.img.content.id;
          this.sim.url = this.img.content.url;
          this.sim.alt = this.img.alt;
          this.uploadImage = false;
          this.type = "";
          this.file = "";
        }, 2000);
    ...
    confirmUse() {
      if (this.type === "new") {
        ...
        this.sim.url = this.img.content.url;
        this.sim.alt = this.img.content.alt;
        this.type = "";
        this.file = "";
        this.img.alt = "";
      }
